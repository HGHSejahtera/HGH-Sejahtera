-- ==============================================================================
-- Migration 043: Fix process_agent_order_upload for Dropped Columns
-- Description: Updates process_agent_order_upload RPC to remove "OrderStatus"
-- from the INSERT INTO public."ImportedOrders" statement, as that column
-- was permanently dropped in Migration 039.
-- ==============================================================================
...
BEGIN
    ...
    LOOP
        ...
        -- Create Order with OrderAmount = 0 (OrderStatus removed as per Migration 039)
