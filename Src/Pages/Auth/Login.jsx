        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-3 mt-3">
              ...
              <span className="text-xs font-medium text-indigo-400 uppercase tracking-widest">Login</span>
              <span className="w-8 h-[1px] bg-zinc-800"></span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="identifier" className="text-sm font-medium text-zinc-300">User Identifier</Label>
              <Input
                id="identifier"
                type="text"
                value={identifier}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Checkbox id="remember" className="border-zinc-700 data-[state=checked]:bg-indigo-600 data-[state=checked]:text-white" />
                <Label
                  htmlFor="remember"
